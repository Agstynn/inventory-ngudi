...
$res = mysqli_query($conn, "SELECT * FROM perbaikan_alat ORDER BY tanggal DESC");
?>
<!doctype html>
<html><head><meta charset="utf-8"><title>Cetak Perbaikan</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head><body>
<div class="container mt-3">
  <h3>Daftar Perbaikan</h3>
  <table class="table table-bordered"><thead><tr><th>Tanggal</th><th>Nama Alat</th><th>No Seri</th><th>Ruangan</th><th>Status</th><th>Keterangan</th></tr></thead><tbody>
